...
const _0020 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h2 id="${"plutus-off-chain"}"><a aria-hidden="${"true"}" tabindex="${"-1"}" href="${"#plutus-off-chain"}"><span class="${"icon icon-link"}"></span></a>Plutus Off-chain</h2>
...
<ul><li>Notice that, unlike <code>alwaysSucceeds</code>, <code>goodRedeemer</code> <strong>does</strong> have a redeemer with type <code>Int</code>, so we must its type in the <code>GiftSchema</code>.</li></ul>
